...
for env in env_names:
  for seed in seeds:
    for weight in weights:
      ...
      screen_name = 'PPO_'+env[0]+'_'+gaze_loss_type+'_'+weight+'_seed'+seed
      ...
      f.write("OPENAI_LOG_FORMAT='stdout,log,csv,tensorboard' OPENAI_LOGDIR=ppo_models/"+gaze_loss_type+"/"+env[0]+"_"+gaze_loss_type+"_"+weight+'_seed'+seed+" python -m baselines.run --alg=ppo2 --env="+env[1]+"NoFrameskip-v4 --custom_reward pytorch --custom_reward_path reward_models_AAAI2020/gazePred_"+env[0]+"_KL_"+weight+'_seed'+seed+" --seed "+seed+" --num_timesteps=5e7 --save_interval=500 --num_env 9\n")
