...
for env in env_names:
    for seed in seeds:
        screen_name = 'eval_'+env[0]+'_seed'+seed
        ...
        f.write("python evaluateLearnedPolicy.py --env_name "+env[0]+" --checkpointpath "+"ppo_models/base/"+env[0]+"_seed"+seed+"/checkpoints/43000")
        i+=1
