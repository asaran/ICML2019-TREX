...
env_names = [['breakout','Breakout'], ['hero','Hero'],['seaquest','Seaquest'],['spaceinvaders','SpaceInvaders'],['mspacman','MsPacman'],['asterix','Asterix'], ['centipede','Centipede'], ['phoenix','Phoenix']]
#seeds = ['0','1','2']
conv_layer = '1'
user_type = 'expert'
gaze_loss_type = 'KL'
...
bash_file_name = 'reward_'+user_type+'_conv'+conv_layer+'_'+gaze_loss_type+'_'+gaze_reg+'.sh'
...
for env in env_names:
  ...
  screen_name = env[0]+'_'+gaze_loss_type+'_'+gaze_reg+'_reward'
  #f.write("#!/bin/bash")
